...
\end{equation}
Trying to insert $v_{i-1}$ can proove to be difficult. After some algebra one finds that 
...
done with a backward substitution. As we see from equation (\ref{eq:fsi}), we have to add a term $-c_iv_{i+1}/d_i$.
